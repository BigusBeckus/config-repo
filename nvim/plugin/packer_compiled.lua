...
_G.packer_plugins = {
  ...
  ["friendly-snippets"] = {
    loaded = true,
    path = "/home/beck/.local/share/nvim/site/pack/packer/start/friendly-snippets",
  ...
  ["indent-blankline.nvim"] = {
    loaded = true,
    path = "/home/beck/.local/share/nvim/site/pack/packer/start/indent-blankline.nvim",
  ...
  ["nvim-comment"] = {
    loaded = true,
    path = "/home/beck/.local/share/nvim/site/pack/packer/start/nvim-comment",
